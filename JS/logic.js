...
document.onkeyup = function(event) {
    ...
    function coconutOnce1() {
        if (!pickedUpCoconut1 && zCoordinate == -11 && xCoordinate == -18) {
            pickUpCoconut1();
        }
    }
    ...
    function coconutOnce2() {
        if (!pickedUpCoconut2 && zCoordinate == -5 && xCoordinate == -30) {
            pickUpCoconut2();
        }
    }
    ...
    function saplingOnce1() {
        if (!pickedUpSapling1 && zCoordinate == 6 && xCoordinate == 9) {
            pickUpSapling1();
        }
    }
    ...
    function saplingOnce2() {
        if (!pickedUpSapling2 && zCoordinate == 20 && xCoordinate == 20) {
            pickUpSapling2();
        }
    }
    ...
    function shovelOnce() {
        if (!pickedUpShovel && zCoordinate == 100 && xCoordinate == 50) {
            pickUpShovel();
        }
    }
    //picking up stuff functions
    coconutOnce1();
    coconutOnce2();
    saplingOnce1(); 
    saplingOnce2(); 
